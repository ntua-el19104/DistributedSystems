...
public class Transaction {
  ...
  public Transaction(double amount, PublicKey senderAddress, PublicKey receiverAddress, int nonce,
      String message) {
    this.amount = amount;
  ...
  public String toString() {
    String senderAddressToString =
        senderAddress != null ? Base64.getEncoder().encodeToString(senderAddress.getEncoded())
            : "null";
