...
public class MQConfig {
  ...
  @Bean
  public Binding connectRequestBinding(Queue connectRequestQueue,
      FanoutExchange connectRequestExchange) {
  ...
  @Bean
  public Binding connectAcceptBinding(Queue connectAcceptQueue,
      FanoutExchange connectAcceptExchange) {
  ...
  @Bean
  public Binding nodesAddressesBinding(Queue nodesAddressesQueue,
      FanoutExchange nodesAddressesExchange) {
